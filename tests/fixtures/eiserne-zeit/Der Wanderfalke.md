...
card:
  system: eiserne-zeit
data:
  name: Der Wanderfalke
  card-type-label: Gefährte
  reference: "Die Falknerin, S. 8"
```

*Art: Wanderfalke, abgetragen*

**Werte:** KW 4; TP 1w4 (mindestens 2), AB +1, Schlag (1w4); RK 13; fliegt.
...
| Stufe | Boni |
|---|---|
| 1 | Klassenbonus auf GES oder INT (wähle 1 von 2) |
| 2 | TP +1 |
| 3 | Ein weiteres Kommando nach Wahl der Spielleitung |
